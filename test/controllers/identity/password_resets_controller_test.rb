...
class Identity::PasswordResetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get edit" do
    sid = @admin_account.generate_token_for(:password_reset)
  ...
  test "should send a password reset email" do
    assert_enqueued_email_with AdminAccountMailer, :password_reset, params: { user: @admin_account } do
      post identity_password_reset_url, params: { email: @admin_account.email }
    end
